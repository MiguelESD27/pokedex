                ...
                cardFooter={(
                  <CardFooter>
                    <section className="flex">
                      <button
                        className="ml-4 mt-8 mb-2 px-3 py-3 border border-gray-300 text-gray-400 font-bold rounded-sm hover:text-red-500 hover:border-red-400 transition-colors cursor-pointer"
                        onClick={() => { toggleFavorite(data?.id); }}
                      >{isFavorite ? '♥' : '♡'}</button>
                      <button
                        className="flex-1 mx-4 mt-8 mb-2 px-4 py-3 bg-green-600 text-white font-bold rounded-sm cursor-pointer"
